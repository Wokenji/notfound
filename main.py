...
def set_master(update, context):
    ...
    update.message.reply_text('[{}](tg://user?id={}) Sözü izah edir ❗️'.format(username,user_id), reply_to_message_id=True, reply_markup=reply_markup, parse_mode=ParseMode.MARKDOWN)
